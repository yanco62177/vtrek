                                     ...
                                     <div class="panel-body">
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                            <div class="col-md-10">
                                              <label class="col-md-4 control-label" for=
                                              "DBIRTH">Birth Day:</label>

                                              <div class="col-md-8">
                                                 <input class="form-control input-sm" id="DBIRTH" name="DBIRTH" placeholder=
                                                    "Birth Day" type="date" value=""  required>
                                              </div>
                                            </div>
                                          </div>
                                       ...
                                       <div class="form-group">
                                            <div class="col-md-10">
                                              <label class="col-md-4 control-label" for=
                                              "CHOUSENUM">House Number:</label>

                                              <div class="col-md-8">
                                                 <input class="form-control input-sm" id="CHOUSENUM" name="CHOUSENUM" placeholder=
                                                    "House Number" type="text" value=""  required>
                                              </div>
                                            </div>
                                          </div>
                                            ...
                                            <div class="col-md-10">
                                              ...
                                              <div class="col-md-8">
                                                 <input class="form-control input-sm" id="ZIPCODE" name="ZIPCODE" placeholder=
                                                    "Zipcode" type="number" value="" required>
                                              </div>
                                            </div>
                                          </div>
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder=
                                                "+63 0000000000" type="number" value=""  required>
                                          </div>
                                        </div>
                                      </div>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p><input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />  I 
                                           <small>Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of Vapetrek.</small>
